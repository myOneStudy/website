  ...
  return (
    <section>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-purple-400">
            ...
            <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
              ...
              <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6" data-aos="fade-right">
                <div className="md:pr-4 lg:pr-12 xl:pr-16">
                  ...
                  <p className="text-lg text-gray-1000 mb-4">Upload your notes, lecture notes, powerpoints, and other materials.</p>
                ...
                <div className="md:pl-4 lg:pl-12 xl:pl-16">
                  ...
                  <ul className="text-lg text-gray-1000 mb-4 md:-mb-2">
                    ...
                    <li className="flex items-center">
                      ...
                      <span>Multiple choice flashcards</span>
                    </li>
                  </ul>
                </div>
              </div>
                ...
                <div className="md:pr-4 lg:pr-12 xl:pr-16">
                  ...
                  <ul className="text-lg text-gray-1000 mb-4 md:-mb-2">
                    ...
                    <li className="flex items-center">
                      ...
                      <span>Active recall using semantic analysis</span>
                    </li>
                  </ul>
                </div>
              </div>
