        ...
        <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          <div className="mr-auto place-self-center lg:col-span-7">
            <h1 className="text-4xl md:text-5xl font-semibold leading-tighter tracking-tighter text-gray-1000 mb-4" data-aos="zoom-y-out">
              A study tool you'll actually {" "}
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-blue-1000">love using.
              </span>
            </h1>
            <p className="max-w-2xl text-md md:text-xl text-gray-1000 mb-8" data-aos="zoom-y-out">
              Study more efficiently by instantly converting course materials into text, image, and multiple choice flashcards. Study in a feature-rich, sleek interface.
            </p>
            <div className="mb-6">
